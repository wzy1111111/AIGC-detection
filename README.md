...
## Setup
Refer to [CNNSpot](https://github.com/peter
wang512/CNNDetection) and [Dire](https://github.com/ZhendongWang6/DIRE)
...
1. CNNSpot, FreDect, Fusing, Gram-Net,Phase
   ```
   ...
   CUDA_VISIBLE_DEVICES="1,2,3" python -m torch.distributed.launch --nnodes=1 --nproc_per_node=3 --use_env train.py --name test --dataroot ./datasets/progan --detect_method CNNSpot --fix_backbone --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
   ```
2. LGrad
   ```
...
3. LNP
   ...
   python train.py --name test --dataroot [your data path] --detect_method CNNSpot --blur_prob 0 --jpg_prob 0
   CUDA_VISIBLE_DEVICES="0,1,2,3" python -m torch.distributed.launch --nnodes=1 --nproc_per_node=4 --use_env train.py --name test --dataroot ./datasets/lnp --detect_method CNNSpot --blur_prob 0 --jpg_prob 0
   CUDA_VISIBLE_DEVICES="2" python train.py --name test --dataroot ./datasets/lnp --detect_method CNNSpot --blur_prob 0 --jpg_prob 0
   ```
4. DIRE
   ```
...
5. UnivFD
   ...
   0.72
   CLIP:ViT-L/14
   python train.py --name test --dataroot ./datasets/progan --detect_method UnivFD --fix_backbone --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
   python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --use_env train.py --name test --dataroot ./datasets/progan --detect_method UnivFD --fix_backbone --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
6.Phase
 CUDA_VISIBLE_DEVICES="0,3" python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --use_env train.py --name test --dataroot ./datasets/progan --detect_method Phase --fix_backbone --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
7.learning out-of-distribution features(SSD)

   ```
    CUDA_VISIBLE_DEVICES="1,0" python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --use_env train.py --name test --dataroot /workspace/datasets/progan --detect_method SSD --fix_backbone --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100

    CUDA_VISIBLE_DEVICES="1,0" python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --use_env train.py --name test --fix_backbone --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
    CUDA_VISIBLE_DEVICES="0" python train.py  --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
    CUDA_VISIBLE_DEVICES="1" python train3.py --dataroot /workspace/datasets/progan1  --detect_method FakeInversion --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100
    python train1.py  --blur_prob 0.1 --blur_sig 0.0,3.0 --jpg_prob 0.1 --jpg_method cv2,pil --jpg_qual 30,100 --detect_method LOOD --dataroot /workspace/datasets/progan
    CUDA_VISIBLE_DEVICES="0" python test.py

多机多卡：
scp -r -P 1013 /data/wzy/datasets vgg@192.10.84.106:/mnt/ymh/ijcai
## Test on datasets
```
