...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None, r=0,lora_alpha: int = 1,lora_dropout=0.05):
        ...
        self.out_proj = Linear(embed_dim, embed_dim, bias=True, merge_weights=False, r=r,lora_alpha=lora_alpha,lora_dropout=lora_dropout)
